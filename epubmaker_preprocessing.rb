...
# Make EBK hyperlinks
filecontents = filecontents.gsub(/(<p class="EBKLinkSourceLa">)(.*?)(<\/p>)(<p class="EBKLinkDestinationLb">)(.*?)(<\/p>)/,"\\1<a href=\"\\5\">\\2</a>\\3").gsub(/(<p class="EBKLinkSourceLa"><a href=")(<span class=".*?">)(.*?)(<\/span>">)/,"\\1\\3")

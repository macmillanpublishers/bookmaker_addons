    ...
    $('p:contains("-"):not(:has(span.spanISBNisbn))').each(function (){
      ...
      if (result === true) {
       ...
       $(this).find("*").each(function () {
          $(this).html($(this).text().replace(/-/g,"<span class='longhyphenhelper' style='font-size: 2pt; vertical-align:top;'>FARRRGGGGOOOOOOOOO</span>-<span class='longhyphenhelper' style='font-size: 2pt; vertical-align:top;'> </span>"));
        });

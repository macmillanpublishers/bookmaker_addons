    ...
    $('p:contains("-"):not(:has(span.spanISBNisbn))').each(function (){
      ...
      if (result === true) {
       ...
       $(this).find("*").each(function () {
          $(this).text( $(this).text().replace(/-/g,"<span class='longhyphenhelper' style='font-size: 2pt; vertical-align:top;'> </span>-<span class='longhyphenhelper' style='font-size: 2pt; vertical-align:top;'> </span>") );
        });

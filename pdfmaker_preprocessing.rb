...
filecontents = File.read(Bkmkr::Paths.outputtmp_html, :encoding=>"UTF-8").gsub(/src="images\//,"src=\"#{ftp_dir}/").gsub(/([a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9]\s\. \. \.)/,"<span class=\"bookmakerkeeptogetherkt\">\\0</span>").gsub(/(\s)(\w\w\w*?\.)(<\/p>)/,"\\1<span class=\"bookmakerkeeptogetherkt\">\\2</span>\\3").gsub(/(.)?(—)(.)?/,"\\1&\#8203;\\2&\#8203;\\3")

...
# as per wdv-438, this function is no longer needed, and actively causing problems:
# - if the 4th param has double-quotes, it doesn't work on windows; single quotes doesn't properly insert the string
# - commenting instead of removing in case this sort of function comes in handy down the road.
